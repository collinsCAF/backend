...
const sendMessages = (name, email, message) => {
  return new Promise((resolve, reject) => {
    ...
    const mailOptions = {
      ...
      to: "templevoke@gmail.com",
      subject: 'Donation Info',
      html: `
        <!DOCTYPE html>
        <html lang="en">
        <head>
          ...
          <style>
            ...
            .container { max-width: 600px; background-color: #ffffff; padding: 20px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); }
            .header { background-color: #4CAF50; color: #ffffff; padding: 10px 0; }
            .header img { width: 90%; height: auto; }
            .content h1 { color: #333333; margin: 20px 0; }
            .content h2 { color: #4CAF50; margin: 20px 0; }
            .content p { color: #555555; line-height: 1.6; }
            .footer { margin-top: 20px; color: #888888; font-size: 12px; }
